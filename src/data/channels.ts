...
export const channels: Channel[] = [
  ...
  },
  {
    ...
    name: 'Kix',
    category: 'Foreign',
    logo: 'https://i.imgur.com/bWt954E.png',
    epgId: '',
    epgSource: 'none',
    stream: {
      url: 'https://converse.nathcreqtives.com/channels/kix-ph/manifest.mpd?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..G9RVqvRccbU9QyWSE8yu67IR2-2-yotmB1AyIa-Cheo',
      type: 'dash',
      drm: {
        scheme: 'clearkey',
