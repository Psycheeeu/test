...
export const channels: Channel[] = [
  ...
  },
  {
    ...
    epgId: 'HITS.Movies.HD..sg',
    epgSource: 'none',
    stream: {
      url: 'https://converse.nathcreqtives.com/channels/hits-movies/manifest.mpd?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..G9RVqvRccbU9QyWSE8yu67IR2-2-yotmB1AyIa-Cheo',
      type: 'dash',
      drm: {
        scheme: 'clearkey',
        clearkeys: { 'f56b57b32d7e4b2cb21748c0b56761a7': '3df06a89aa01b32655a77d93e09e266f' },
      },
    },
  ...
  },
  {
    ...
    name: 'Hits Now',
    category: 'Entertainment',
    logo: 'https://i.imgur.com/POBoG99.png',
    epgId: 'HITS.NOW.(HD).sg',
    epgSource: 'none',
    stream: {
  ...
  },
  {
    ...
    epgId: 'jp97',
    epgSource: 'none',
    stream: { url: 'https://akariko.netgenx.site/stream/jp/pigoo_nsfw/stream-output.m3u8?mode=hls', type: 'hls' },
    isAdult: true,
  ...
  },
  {
    ...
    epgId: 'v_paradise',
    epgSource: 'none',
    stream: { url: 'https://akariko.netgenx.site/stream/jp/v_paradise_nsfw/stream-output.m3u8?mode=hls', type: 'hls' },
    isAdult: true,
